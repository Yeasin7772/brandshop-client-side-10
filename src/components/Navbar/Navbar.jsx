...
const Navbar = () => {
    ...
    const navLinks = <>
        ...
        <li className="font-semibold text-white"><NavLink to='/addProduct'>Add Product</NavLink></li>
        <li className="font-semibold text-white"><NavLink to='/myCard'>My Cart</NavLink></li>
        <li className="font-semibold text-white"><NavLink to='/Contacts'>Contacts</NavLink></li>
    ...
    return (
        <div>
            ...
            <div className="navbar bg-[#5f5e5e] shadow-lg">
                <div className="navbar-start">
                    ...
                    <img className="normal-logo w-40" src="	https://quattro.true-emotions.studio/wp-content/themes/quattro/images/logo-w.svg" alt="" />
                </div>
